...
public class ResSkillConfigs {
    ...
    public static SkillCfg sk_1030 = new SkillCfg {
     ...
     //让筒子爆炸
    public static SkillCfg sk_1031 = new SkillCfg {
        skillID = 1031,
        iconName = "arthur_sk2",
        aniName = "atk",
        releaseMode = ReleaseModeEnum.Click,
    ...
    //肉蛋葱鸡
    public static SkillCfg sk_1032 = new SkillCfg {
        skillID = 1032,
        iconName = "arthur_sk1",
        aniName = "atk",
        releaseMode = ReleaseModeEnum.Postion,
